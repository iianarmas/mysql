-- corporate branch
-- if a table has a foreign key that references to another table that hasn't been created yet, leave the row data to NULL and insert it later

INSERT INTO employee VALUES(100, 'David', 'Wallace', '1967-11-17', 'M', 250000, NULL, NULL);
INSERT INTO branch VALUES(1, 'Corporate', 100, '2006-02-09');

-- updating first table after creating the 2nd table that it referenced to
UPDATE employee
SET branch_id = 1
WHERE emp_id = 100;
...
INSERT INTO branch_supplier VALUES(2, 'Uniball', 'Writing Utensil');
